...
const Index = ({products: serverSideProducts}) => {
    ...
    <h3> Explore as</h3>
              ...
              />
                                        ...
                                        <FormGroup>
                                            <div className="d-flex flex-row gap-5 ">
                                                <div className="text-center fw-bold">
                                                    <Label className="text-center fw-bold" for="contact">Mobile
                                                        Number</Label>
                                                </div>
                                                <div className="ml-3"><FormGroup check>
                                                    ...
                                                    />
                                                    <small for="whatsappCheckbox" className="text-muted font-small ml-1"
                                                           check>
                        ...
                        <Col xs={6} md={3}>
                            <Button onClick={() => {
                                window.open('http://srv481744.hstgr.cloud:8081/', '_blank');
                ...
                <span className="text-center align-baseline">
                  ...
                  <span> Click if above number is on WhatsApp</span>
                        ...
                        <Modal isOpen={isCorporateModalOpen} toggle={() => setCorporateModalOpen(false)}
                               style={{maxWidth: '500px'}} className=".bd-example-modal-sm">
                  ...
                  <span> Click if above number is on WhatsApp</span>
                                    ...
                                    <button className={"btn btn-primary"} style={{borderRadius: '10px'}}>
                                        <Link href={"/shop"} color="primary" legacyBehavior>
                                            Submit
                                        </Link>
                                    </button>
                                </form>
                                    ...
                                    <div>
                                        <div>
                                            {item.categories && item.categories.length > 0 && (
                                                <Link href={`/category/${item.categories[0].id}`} legacyBehavior>
            ...
            <div>
                <Row className={"justify-content-between"}
                     style={{background: "radial-gradient(circle, rgba(226,128,57,1) 0%, rgba(231,63,63,1) 100%)"}}>

                    <section className={`${s.top_daily} img-fluid`}>
                        <div style={{display: 'inline-block'}}>
                            <h5 className={`${s.text_white} fw-bold text-white`} style={{
                                display: 'inline-block',
                                marginLeft: '30px',
                                marginTop: '15px',
                                verticalAlign: 'top'
                            }}>Daily Offer on Your Device</h5>
                            <br/>
                            <p className={`${s.text_white} fw-bold text-white`} style={{
                                display: 'inline-block',
                                fontSize: "0.9rem",
                                marginLeft: '31px',
                                verticalAlign: 'top'
