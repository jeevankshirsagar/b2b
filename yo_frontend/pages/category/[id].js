  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`${categoryData.meta_description || 'yodigital ecommerce B2B'}`}  />
        <meta name="keywords" content={`${categoryData.keywords || "ecommerce, yodigital"}`} />
        <meta name="author" content={`${categoryData.meta_author || "YoDigital PVT LTD"}`} />
        <meta charSet="utf-8" />


        <meta property="og:title" content={`${categoryData.meta_og_title || "YoDigital"}`} />
        <meta property="og:type" content="website"/>
        <meta property="og:url" content={`${categoryData.meta_og_url || "https://localhost:3000/"}`} />
        <meta property="og:image" content={`${categoryData.meta_og_image || "https://localhost:3000/images/blogs/content_image_six.jpg"}`} />
        <meta property="og:description" content={`${categoryData.meta_description || 'yodigital ecommerce B2B'}`} />
        <meta name="twitter:card" content="summary_large_image" />

        <meta property="fb:app_id" content={`${categoryData.meta_fb_id || "712557339116053"}`} />

        <meta property="og:site_name" content={`${categoryData.meta_og_sitename || "yodigital"}`} />
        <meta name="twitter:site" content={`${categoryData.post_twitter || "@yodigital"}`} />
      </Head>
