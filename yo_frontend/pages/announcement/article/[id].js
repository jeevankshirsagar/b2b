  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`${post.meta_description || 'yodigital b2b store'}`}  />
        <meta name="keywords" content={`${post.keywords || "yodigital b2b"}`} />
        <meta name="author" content={`${post.meta_author || "yodigital pvt ltd."}`} />
        <meta charSet="utf-8" />


        <meta property="og:title" content={`${post.meta_og_title || "yodigital"}`} />
        <meta property="og:type" content="website"/>
        <meta property="og:url" content={`${post.meta_og_url || "https://localhost:3000/"}`} />
        <meta property="og:image" content={`${post.meta_og_image || "https://site_img.jpg"}`} />
        <meta property="og:description" content={`${post.metadescription || 'yodigital b2b store'}`} />
        <meta name="twitter:card" content="summary_large_image" />

        <meta property="fb:app_id" content={`${post.meta_fb_id || "712557339116053"}`} />

        <meta property="og:site_name" content={`${post.meta_og_sitename || "yodigital"}`} />
        <meta name="twitter:site" content={`${post.post_twitter || "@yodigital"}`} />
      </Head>
      <img
